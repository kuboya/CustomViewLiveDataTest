...
//    @BindingAdapter("android:exampleString")
//    public static void setText(MyView view, LiveData<String> value) {
//        String name = value != null ? value.getValue() : null;
//        view.setExampleString(name);
//    }
    /**
